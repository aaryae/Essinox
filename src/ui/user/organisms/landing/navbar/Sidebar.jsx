...
export default function Sidebar({ isSidebarOpen, setIsSidebarOpen, activePath }) {
  return (
    ...
    >
      <button className='absolute top-4 right-4' aria-label='Close menu' onClick={() => setIsSidebarOpen(false)}>
            ...
            return (
              <Link
                ...
                className={`block rounded-lg px-4 py-3 font-medium transition ${
                  isActive ? 'bg-blue-50 text-blue-900' : 'text-gray-700 hover:bg-gray-100 hover:text-blue-900'
                }`}
              >
                {label}
              </Link>
