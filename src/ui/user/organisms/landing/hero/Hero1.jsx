...
const Hero1 = () => {
  return (
    <section className='flex  max-[1050px]:flex-wrap w-full justify-between bg-[#205187] py-12 px-8 pr-0 md:pr-8  items-center'>
      <div>
        <div className='flex flex-col max-w-xl py-10'>
          <h1 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light text-white mb-4 leading-tight max-[1640px]:w-1/2'>
          ...
          <p className='text-[0.85rem] sm:text-[0.9rem] md:text-[0.95rem] lg:text-[0.9rem] text-blue-100 mb-8 max-[1640px]:w-1/2'>
