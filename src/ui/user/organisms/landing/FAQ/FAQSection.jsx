...
const faqData = [
  {
    ...
    answer:
      'Essinox lenses are made with advanced optical technology and premium coatings to deliver clear vision, comfort, and durability.',
  },
  {
    question: 'Are Essinox lenses suitable for digital screen use?',
    answer:
      'Yes, Essinox lenses help reduce eye strain and blue light exposure caused by prolonged digital device use.',
  },
  {
    question: 'Do Essinox lenses provide UV protection?',
    answer:
      'All Essinox lenses offer effective UV protection to help safeguard your eyes from harmful ultraviolet rays.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes. Essinox lenses are available with various coatings, including anti-reflective, blue filter, UV protection, and hydrophobic coatings.',
  },
]
